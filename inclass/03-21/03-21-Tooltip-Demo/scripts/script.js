    ...
    */
    ...
    points.on("mouseover", function(e, d) {
        ...
        tooltip.style("visibility", "visible")
            .style("top", `${y}px`)
            .style("left", `${x}px`)
            // `${y}px` : This is just standard HTML syntax
            // the code line below mentions how the text should be represented inside the tooltip - country, continent and value
