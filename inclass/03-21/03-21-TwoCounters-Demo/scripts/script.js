...
// specifying the width of the visual mapping
...
// specifies the width and the height
...
function dataJoin(data) {
    ...
    const circle = g.selectAll("circle")
         ...
         * 
         * The D3 method .schemeTableau10 is used to return ten categorical 
         * colors authored by Tableau as part of Tableau 10.
         * For more information, see:
         *      https://www.geeksforgeeks.org/d3-js-schemetableau10-method/
         */
        // we are not binding the circles with a data set, but generating them with numbers on the fly
    ...
    g.on('click', (event, d) => {
        ...
        // ternary (if index == 0 then return 1 else 0)
