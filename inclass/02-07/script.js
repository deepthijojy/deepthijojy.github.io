...
// d3.text("/inclass/02-07/datasets/file.txt").then(parseLOG);
...
// d3.csv("/inclass/02-07/datasets/cities-sm.csv").then(parseLOG);
...
// d3.json("/inclass/02-07/datasets/countrycode-sm.json").then(parseLOG);
...
d3.csv("/inclass/02-07/datasets/cities-sm.csv").then(function(data){
